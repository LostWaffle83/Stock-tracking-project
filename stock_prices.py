#CEIS150 March 2022 Session Andrew Morris Course Project Module 2

#deffing class to being tracking selected stocks
class Stock:
    def __init__(self, symbol, name, shares):
        self.symbol = symbol
        #symbol used to define stock
        self.name = name
        #full name of stock 
        self.shares = shares
        #number of shares owned
        self.DataList = [] # list of stock data (date, closing price, and volume of shares sold) 
        
    # setting up method for adding stock data    
...
class DailyData:
    def __init__(self, date, close, volume):
        self.date = date
        #date to correlate stock information
        self.close = close
        #closing price of stock on selected date
        self.volume = volume
        #volume of shares sold on selected date
