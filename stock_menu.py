#CEIS150 March 2022 Session Andrew Morris Module 3 Project
...
def add_stock(stock_list):
      option = ""
      while option != "0":
          print("Let's update your portfolio with a new stock!")
          symbol = input("What is the new stock's symbol? ").upper()
          name = input("What is the full name of the stock? ")
          shares = float(input("How many shares did you purchase? "))
          new_stock = Stock(symbol, name, shares)
          stock_list.append(new_stock)
          option = input("Press enter to update with a new stock, or press 0 to quit:  ")
          

# Remove stock and all daily data
def delete_stock(stock_list):
    print("Sold all your shares? Let's remove a stock from your portfolio")
    print("Here's your stocks: [ ", end="")
    for stock in stock_list:
        print(stock.symbol, " ",end="")
    print("]")
    symbol = input("Which stock did you sell?: ").upper()
    found = False
    i = 0
    for stock in stock_list:
    ...
    if found == True:
        ...
        print("Sorry, I don't see that stock in your portfolio")
    _=input("Press enter to return to the main menu")    
    
# List stocks being tracked
def list_stocks(stock_list):
    print("Let's take a look at your portfolio")
    print("---\tHere are your active stocks\t---")
...
def add_stock_data(stock_list):
    ...
    if found == True:
       ...
       print("Sorry I can't seem to that stock in your portfolio")
    _= input("Press enter to return to the main menu")

    
def investment_type(stock_list):
    print("Time to build an investment account! ---")
    balance = float(input("How much are you investing today?: "))
    number = input("What account should we tie this to?: ")
    acct= input("Do you want a Traditional (t) or Robo (r) account: ")
    if acct.lower() == "r":
        years = float(input("How many years until you expect to retire?: "))
        robo_acct = Robo(balance, number, years)
        print("Your projected investment return is ",robo_acct.investment_return())
        print("\n\n")
    elif acct.lower() == "t":
...
def display_chart(stock_list):
    print("Let's chart your stocks and see how they've performed!")
    print("Here's your stocks: [ ", end="")
    for stock in stock_list:
        print(stock.symbol, " ",end="")
    print("]")
    symbol = input("Which stock did you want review?: ").upper()
    found = False
...
def import_stock_csv(stock_list):
    print("\nLet's bring in some histrorical data on a stock!")
    print("Stock List: [",end="")
    for stock in stock_list:
       print(stock.symbol," ",end="")
    print("]")
    symbol = input("What's the symbol for the stock you're interested in?: ").upper()
    filename = input("How is the historical data file labeled?: ")
    for stock in stock_list:
        if stock.symbol == symbol:
...
def display_report(stock_list):
    for stock in stock_list:
       print("Here's the report you requested: ")
       print("Data on: ", stock.symbol, stock.name)
    ...
    #variable intialization
       ...
       if count > 0:
          ...
          print("Low Price: ",(highVolume))
          print("Low Price: {:,.2f}".format(volume_total/count))
